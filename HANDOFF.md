...
> **For the next chat session.** Read this FIRST. Cross-reference the canonical
> documentation set below for everything you need to keep building.

**Last updated:** 2026-06-18 (Wave 23 — full documentation consolidation before migration to VS Code).

---

## ⭐ Canonical documentation suite (Wave 23, 2026-06-18)

The 11 docs below were generated by an audit pass over the entire repository.
Together they let any developer (human or AI) pick up the project cold.
**Read `HANDOFF_GUIDE.md` first** — it has the conventions, workflows, and
"what to never do".

| Doc | What it covers | When to read |
|---|---|---|
| [`HANDOFF_GUIDE.md`](HANDOFF_GUIDE.md) | Conventions, workflows, forbidden things, the 6 systems | **Always start here** |
| [`PROJECT_OVERVIEW.md`](PROJECT_OVERVIEW.md) | What this project is and why | First session ever |
| [`ARCHITECTURE.md`](ARCHITECTURE.md) | Stack, folder tree, decisions, data flow | When designing changes |
| [`COMPONENTS.md`](COMPONENTS.md) | All 37 components inventoried | Before building UI |
| [`SCREENS.md`](SCREENS.md) | All 34 pages + navigation | Routing or new screens |
| [`DATABASE.md`](DATABASE.md) | 21 tables, 50+ RLS policies, schemas | Touching DB |
| [`API_INTEGRATIONS.md`](API_INTEGRATIONS.md) | Edge functions, push, scrapers, env vars | External-facing work |
| [`BUSINESS_RULES.md`](BUSINESS_RULES.md) | 150+ rules across permissions, validations, calculations | Anything user-visible |
| [`TECH_DEBT.md`](TECH_DEBT.md) | Catalogued debt, P1 → P4 | Before refactoring |
| [`LESSONS_LEARNED.md`](LESSONS_LEARNED.md) | 25 lessons from prior pain | When something breaks |
| [`ROADMAP.md`](ROADMAP.md) | What to work on next, prioritized | "What now?" |

**Historical references** (kept for traceability):
- [`SESSION_LOG_2026-06-17.md`](SESSION_LOG_2026-06-17.md) — Waves 9-22 narrative
- [`WAR_ROOM_LOG.md`](WAR_ROOM_LOG.md) — chronological per-wave technical log
- [`PLANNING.md`](PLANNING.md) — original product spec
- [`README.md`](README.md), [`DEPLOY.md`](DEPLOY.md) — basic onboarding
